...
import { compareVersions, isBump, parseVersion, readPackageVersion, setPackageVersion } from "../../scripts/release/version.ts";
...
describe("readPackageVersion", () => {
  it("exige o campo version", () => {
    ...
    expect(() => readPackageVersion(dir)).toThrow(/sem o campo version/);
  });
});
